...
export const LIST_BLOCKS_EN: Record<string, ListItem[]> = {
  ...
  "estadisticas:list:kpis": [
    { cifra: "57", texto: "of the Institute's competitive research projects" },
    { cifra: "2,9M€", texto: "in funding from competitive calls" },
  ...
  "estadisticas:list:proyectos-financiadoras": [
    { etiqueta: "European Commission / EU", valor: "25" },
    { etiqueta: "University of Salamanca", valor: "12" },
    { etiqueta: "Ministry (Government of Spain)", valor: "8" },
    { etiqueta: "FECYT", valor: "6" },
    { etiqueta: "Junta de Castilla y León", valor: "3" },
    { etiqueta: "Other", valor: "3" },
  ],
