...
export const LIST_BLOCKS_EN: Record<string, ListItem[]> = {
  ...
  "estadisticas:list:kpis": [
    { cifra: "114", texto: "research projects involving the IUCE" },
    { cifra: "11,9M€", texto: "in funding across the projects it takes part in" },
    ...
    { cifra: "40", texto: "national and international research networks" },
  ],
  // Sólo por las etiquetas «Hasta 2019»; las cifras son las mismas que en ES.
  "estadisticas:list:proyectos-por-ano": [
    { etiqueta: "Up to 2019", valor: "23" },
  ...
  "estadisticas:list:proyectos-importe": [
    { etiqueta: "Up to 2019", valor: "1514" },
  ...
  "estadisticas:list:proyectos-financiadoras": [
    { etiqueta: "European Commission / EU", valor: "39" },
    { etiqueta: "Ministry (Government of Spain)", valor: "27" },
    { etiqueta: "University of Salamanca", valor: "19" },
    { etiqueta: "FECYT", valor: "8" },
    { etiqueta: "Junta de Castilla y León", valor: "7" },
    { etiqueta: "INCIBE", valor: "5" },
    { etiqueta: "Other", valor: "9" },
  ],
  "estadisticas:list:contratos-entidades": [
    ...
    { etiqueta: "RTVE Corporation", valor: "2" },
    { etiqueta: "OEI", valor: "2" },
    { etiqueta: "USAL Healthcare Complex", valor: "2" },
    { etiqueta: "Other entities", valor: "25" },
  ],
  ...
  "estadisticas:list:redes-ambito": [
    { etiqueta: "International", valor: "19" },
    { etiqueta: "National", valor: "17" },
    { etiqueta: "Worldwide", valor: "1" },
    { etiqueta: "Regional", valor: "1" },
    { etiqueta: "Local", valor: "1" },
    { etiqueta: "Unspecified", valor: "1" },
  ],
  "estadisticas:list:gestion-categorias": [
    ...
    { etiqueta: "Evaluation (quality agencies)", valor: "45" },
    { etiqueta: "Editorial committees and boards", valor: "40" },
    { etiqueta: "Group and unit leadership", valor: "40" },
    { etiqueta: "Other directorships and coordination roles", valor: "26" },
    { etiqueta: "Other management positions", valor: "16" },
    { etiqueta: "Scientific societies and boards", valor: "15" },
    { etiqueta: "Scientific commissions and committees", valor: "13" },
